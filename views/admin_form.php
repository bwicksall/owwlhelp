...
<form method="post" novalidate>
  ...
  <?php if ($requester_verified): ?>
    <div class="section-card mb-4">
      ...
      <div class="row g-3">
        <div class="col-12">
          <label for="admin_question" class="form-label">Question</label>
          <textarea class="form-control" id="admin_question" name="admin_question" rows="4" required><?= h($admin_question) ?></textarea>
        </div>
      </div>
    </div>
