  ...
  <?php if ($requester_verified): ?>
    ...
    <div class="section-card mb-4 oc-type-fields" data-oc-type="Audiobook">
      ...
      <div class="row g-3">
        ...
        <div class="col-md-6"><label class="form-label" for="oc_audiobook_abridged_unabridged">Abridged, Unabridged, or Not specified</label><input class="form-control" id="oc_audiobook_abridged_unabridged" name="oc_audiobook_abridged_unabridged" value="<?= h(post_value('oc_audiobook_abridged_unabridged')) ?>"></div>
    ...
    <div class="section-card mb-4 oc-type-fields" data-oc-type="Video recording">
      ...
      <div class="row g-3">
        ...
        <div class="col-12"><label class="form-label" for="oc_video_form_of_work">Genre</label><input class="form-control" id="oc_video_form_of_work" name="oc_video_form_of_work" value="<?= h(post_value('oc_video_form_of_work')) ?>"></div>
    ...
    <div class="section-card mb-4 oc-type-fields" data-oc-type="Realia">
      ...
      <div class="row g-3">
        ...
        <div class="col-md-6"><label class="form-label" for="oc_realia_container_size">Size of item, container, box, etc.</label><input class="form-control" id="oc_realia_container_size" name="oc_realia_container_size" value="<?= h(post_value('oc_realia_container_size')) ?>"></div>
